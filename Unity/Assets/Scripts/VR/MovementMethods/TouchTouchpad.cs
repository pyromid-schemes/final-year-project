 ...
 * Class to handle Touchpad (Touched) style movement;
 * Includes validation and movement calculations
*/
namespace VirtualReality.MovementMethods
{
	public class TouchTouchpad : IMovementMethod
	{

		public bool BeginMovement (SteamVR_Controller.Device controller)
		{
			return controller.GetTouch(SteamVR_Controller.ButtonMask.Touchpad);
		}
